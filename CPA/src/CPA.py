...
traces = np.load(r'D:\chipwhisperer_data\data\traces.npy')
pt = np.load(r'D:\chipwhisperer_data\data\plain.npy')
knownkey = np.load(r'D:\chipwhisperer_data\data\key.npy')
